 ...
 */
class InvalidStockLevelsInCartException extends \Exception implements \Throwable, \Stringable
{
    /**
     ...
     */
    public function __construct($error_code, $error, $additional_data = array(
))
    {
        // stub
    }
