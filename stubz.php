...
function parseCommandLine(array $argv): array {
    ...
    if (count($argv) < ($minNonOptions + 1)) {
        fwrite(STDERR, "Usage:\n");
        fwrite(STDERR, "  Normal mode: php stubz.php [options] <source-dir> <output-dir> [stub-b-dir]\n");
        fwrite(STDERR, "    (Requires at least 2 non-option args)\n\n");
        fwrite(STDERR, "  Finder mode: php stubz.php --finder=path/to/finder.php <output-dir> [stub-b-dir]\n");
